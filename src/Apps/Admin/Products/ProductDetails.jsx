...
import VariantAddModel from './Variant/VariantAddModel';
...
export default function ProductModifyForm() {
  ...
  return (
    <Box>
            ...
            <Stack direction="row" sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <Stack direction="row" spacing={1} sx={{}}>
                <Button
                  ...
                  onClick={() => {
                    // setModifyModel(true);
                    router.push(`${ADMIN_ROUTES.PRODUCT_ADD }?id=${productDetails?.product_id}`);
                  }}
                >
                  Edit
                </Button>
      ...
      <VariantAddModel
        open={variantsModifyModel}
        productDetails={productDetails}
        handleClose={() => {
          setVariantsModifyModel(false);
        }}
      />
    </Box>
  );
