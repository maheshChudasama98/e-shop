...
export default function Router() {
  ...
  const AdminRouters = [
    ...
    { path: ADMIN_ROUTES.PRODUCT_DETAILS, element: <ProductAddPage />, title: 'Product Add' },
    { path: ADMIN_ROUTES.PRODUCT_VARIANT_DETAILS, element: <VariantPage />, title: 'Variant Add' },
